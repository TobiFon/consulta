...
const ChatSection = () => {
  return (
    <div className=" w-full flex flex-col-reverse lg:flex-row items-center xl:gap-52 gap-10 container my-10 space-y-10 mt-20 justify-center">
      <div className="relative w-[200px] h-[200px] md:w-[400px] md:h-[400px]  bg rounded-full flex items-center justify-center bg-gradient-to-br from-white to-orange-100 shrink-0">
        ...
        />
        <div className=" bg-purple-950 text-orange-200 rounded-lg px-2 py-4 hidden xl:block w-60 space-y-4 absolute -top-8 -right-40">
